...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/blogs/**").access("isAuthenticated()")
                .antMatchers(HttpMethod.PUT, "/api/blogs/**").access("isAuthenticated()")
                .antMatchers(HttpMethod.DELETE, "/api/blogs/**").access("isAuthenticated()")
